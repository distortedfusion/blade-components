...
<div data-slot="card" {{ $attributes->class([
    ...
    // Specific styling...
    '[&>[data-slot=card-footer]]:border-black/10 dark:[&>[data-slot=card-footer]]:border-white/10' => $style === 'default',
    ...
    // Card header, reset padding on bottom when followed by a card body...
